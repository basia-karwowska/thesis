...
exploration_prob = 0.9 # initial probability of playing an exploratory move
...
for t in range(T):
    ...
    if np.random.rand() < exploration_prob: 
        ...
        # WE DO NOT INCREMENT AS THESE ACTIONS ARE EXTRA FROM THE PERSPECTIVE
        # OF REGRET MINIMIZER, OUTSIDE OF THE ARMS
