...
'''Loss-incurring actions handled interally by hedge and exp3 which propose next 
...
# Adversarial rewards - sequence of T reward vectors of length K (number of arms)
# computed internally by adversary based on its internally generated valuations
# (adversarial strategy) and potential profits (determined by the price grid)
# adversarial_strategy = adversarial_strategy2
# Sequence of rewards privately chosen by an adversary (in practice adversary
